...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $_CONFIG['--color-primary'] = $color_primary ? $color_primary : '#0000ff';
    $_CONFIG['--color-light'] = $color_dark ? $color_dark : 'hsl(210, 11%, 15%)';
    $_CONFIG['--color-dark'] = $color_light ? $color_light : 'hsl(210, 16%, 98%)';

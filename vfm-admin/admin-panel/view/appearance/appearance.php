        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-4">
                        <input class="form-control admin-colorpicker" data-color-selector="primary" value="<?php echo $setUp->getConfig('--color-primary', 'hsl(59,197,234)'); ?>" name="--color-primary"/>
                    </div>
                    <div class="col-4">
                        <input class="form-control admin-colorpicker" data-color-selector="dark" value="<?php echo $setUp->getConfig('--color-dark', '#0000ff'); ?>" name="--color-dark" />
                    </div>
                    <div class="col-4">
    ...
    <div class="col-lg-6">
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mb-3 placeheader position-relative">
                    <div class="pe-3">
                        <div class="placeicon">
                    ...
                    <div class="pe-3">
                        ...
                        <button class="btn btn-danger rounded-0 deletelogo position-relative<?php echo $deletericoclass;?>" data-setting="app_ico">
            ...
            <div class="card-body">
                <div class="d-flex w-100 align-items-center mb-3">
                    <div class="flex-grow-1">
                        <div class="navbar bg-dark shadow-sm placeheader position-relative">

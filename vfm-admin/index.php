...
<header class="navbar fixed-op flex-md-nowrap shadow navbar-expand text-white" style="background-color:#0000ff;">
    <div class="container-fluid">
        <a class="navbar-brand me-0 text-dark text-white px-5 flex-grow-1" href="./" style="margin-left:20%;">                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" style="height:30px;width:30px;margin-top:0%;" class="bi bi-folder-fill"  viewBox="0 0 16 16">
...
Sistema de Gestão de Arquivos
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="<?php echo $setUp->getConfig('script_url'); ?>"><i class="bi bi-house-door"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="../?logout" title="<?php echo $setUp->getString("log_out"); ?>"><i class="bi bi-box-arrow-right"></i> </a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link text-white" href="#" class="dropdown-toggle" data-bs-toggle="dropdown">

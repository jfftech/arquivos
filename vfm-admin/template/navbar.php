...
?>
<nav class="navbar navbar-expand-lg shadow<?php echo $navbarclass; ?>" style ="background-color:#0000ff;">
    <div class="container">
            <?php // Brand button
            ...
            <a class="navbar-brand" href="<?php echo $setUp->getConfig("script_url"); ?>">
                ...
                if ($setUp->getConfig('navbar_logo')) { ?>
                    ...
                    echo '<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" style="height:30px;width:30px;margin-top:0%;" class="bi bi-folder-fill text-white"  viewBox="0 0 16 16">
                    <path d="M9.828 3h3.982a2 2 0 0 1 1.992 2.181l-.637 7A2 2 0 0 1 13.174 14H2.825a2 2 0 0 1-1.991-1.819l-.637-7a2 2 0 0 1 .342-1.31L.5 3a2 2 0 0 1 2-2h3.672a2 2 0 0 1 1.414.586l.828.828A2 2 0 0 0 9.828 3m-8.322.12q.322-.119.684-.12h5.396l-.707-.707A1 1 0 0 0 6.172 2H2.5a1 1 0 0 0-1 .981z"/>
                  </svg> &nbsp; <B class="text-white fs-5">Sistema de Gestão de Arquivo da DQP</b>';
                } ?>
            </a>
                <?php
            } ?>
...
if ($gateKeeper->isUserLoggedIn()) {
    ...
    <li class="nav-item">
        <a class="nav-link text-white edituser" href="#" data-bs-toggle="modal" data-bs-target="#userpanel">
            <?php echo $avaimg; ?> 
    ...
    <li class="nav-item">
        <a class="nav-link text-white" href="<?php echo $setUp->getConfig("script_url"); ?>vfm-admin/">
    ...
    <li class="nav-item">
        <a class="nav-link text-white" href="<?php echo $setUp->getConfig("script_url").$location->makeLink(true, null, ""); ?>">
    ...
    ?>
    <li class="nav-item">
        <a class="nav-link text-white" href="<?php echo $setUp->getConfig("script_url"); ?>">
...
if ($setUp->getConfig('global_search') && $gateKeeper->isAccessAllowed() && $gateKeeper->isAllowed('viewdirs_enable')) { ?>
    <li class="nav-item">
        <a class="nav-link text-white" href="#" data-bs-toggle="modal" data-bs-target="#global-search">
...
if ($setUp->getConfig('show_langmenu')) { ?>
    <li class="dropdown nav-item">
        <a class="nav-link text-white dropdown-toggle" href="#" data-bs-toggle="dropdown" role="button" aria-expanded="false">
        ...
        <ul class="dropdown-menu dropdown-menu-end lang-menu d-none">
          ...
          <div class="modal-body">
            ...
            if (is_array($customfields) && !empty($customfields)) {
              ...
              <li role="presentation" class="nav-item">
                <button class="nav-link text-white active" data-bs-target="#customfields" aria-controls="home" role="tab" data-bs-toggle="pill">
              ...
              <li role="presentation" class="nav-item">
                <button class="nav-link text-white<?php echo $profileTabActive; ?>" data-bs-target="#upprof" aria-controls="home" role="tab" data-bs-toggle="pill">
                    <i class="bi bi-pencil-square"></i> 
                    <?php echo $setUp->getString("update_profile"); ?>
                </button>
              </li>
              <li role="presentation" class="nav-item">
                <button class="nav-link text-white" data-bs-target="#upava" aria-controls="home" role="tab" data-bs-toggle="pill">
